...
<body>
  ...
  ================================================== -->
        ...
        <div class="container marketing" style="width:70%; transform:scaleX(1.1)">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6" onclick="location.href='chefs.php?searchbar=sweet'">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="img/featured-restaurant-food-thumb-img3.jpg" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-lg-6" onclick="location.href='chefs.php?searchbar=salty'">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="img/popular-post-img2-4.jpg" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="widget no-box">
                                ...
                                <a class="btn" href="join-us.html" target="_blank">Register Now</a>
                            </div>
                        </div>
