		...
		<div class="row">
			...
			<div class="right-side col-sm-8 col-md-8 col-lg-9">
				<div class="message-header border-bottom">
					<div class="media">
						<span class="back-btn d-block d-sm-none fa fa-arrow-left"><i class="fa fa-arrow-left"></i></span>
						<a class="media-left" href="">
							<img id="chat-field_image_header" src="img/first.jpg" alt="profile-image">
						</a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                ...
                <ul class="thumbnail-widget">
                  ...
                  <li>
                    <div class="thumb-content"><a href="Aboutus.php">About</a></div>
                  </li>
                </ul>
              </div>
            </div>
